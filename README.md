...
Java-Batch-final-project/ │ ├── Herokuapp/milestorefour/ 🔗 Main automation framework │ ├── src/test/java/herokuapp/milestorefour │ │ ├── basetest │ │ ├── pages │ │ ├── pagestest │ │ ├── listeners │ │ └── utility │ ├── resources │ │ └── config.properties │ ├── pom.xml │ └── testng.xml │ ├── four/ 🔗 Maven setup & wrapper ├── AGILE.md ├── LICENSE └── README.md
